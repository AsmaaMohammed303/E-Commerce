<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="allcat.aspx.cs" Inherits="allcat" %>
<%@Register Src="web_controls/allcat.ascx" tagname="allcat" TagPrefix="users" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <users:allcat ID="dd" runat="server"/>
</asp:Content>

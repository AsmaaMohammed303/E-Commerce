...
<%@ Register src="web_controls/WebUserControlsignup.ascx" tagname="WebUserControlsignup" tagprefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 <div class="art-nav">
								...
								<ul class="art-menu">
									...
									<li><a href="./register.aspx"  class="active"><span class="l">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <uc1:WebUserControlsignup ID="WebUserControlsignup2" runat="server" />
</asp:Content>

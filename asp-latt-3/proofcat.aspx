<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="proofcat.aspx.cs" Inherits="proofcat" %>
<%@Register Src="web_controls/allpro.ascx" tagname="procat" TagPrefix="users" %>
...
<users:procat ID="dd" runat="server" />
</asp:Content>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="category_web_user.ascx.cs" Inherits="admin_user_control_category_web_user" %>
<style type="text/css">
        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="1">
            <asp:View ID="View2" runat="server">
                <table class="style1">
                    <tr>
                        <td colspan="3">
                            <asp:Label ID="title" runat="server" Font-Bold="True" Font-Italic="True" 
                                Font-Size="XX-Large" Font-Underline="True" Text="edit categories"></asp:Label>
                            <br />
                        </td>
                        <td class="style20" rowspan="6" ID="img">
                    ...
                    <tr>
                        <td class="style27">
                            <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="Small" 
                                ForeColor="Black" Text="category num"></asp:Label>
                        </td>
                        <td class="style17">
                            <asp:TextBox ID="txtnum" runat="server" Width="171px"></asp:TextBox>
                        </td>
                        <td class="style21">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td class="style27">
                            <asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Small" 
                                ForeColor="Black" Text="category title"></asp:Label>
                        </td>
                        <td class="style17">
                    ...
                    <tr>
                        <td class="style27">
                            <asp:Label ID="msg" runat="server" Font-Bold="True" ForeColor="Maroon"></asp:Label>
                        </td>
                        <td class="style17">
                            </td>
                        <td class="style21">
            ...
            <asp:View ID="View1" runat="server">
                <table align="center" class="style1">
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" 
                                Font-Underline="True" ForeColor="#000099" Text="search for categories"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style4">
                    ...
                    <tr>
                        <td class="style15">
                            <asp:Label ID="mss" runat="server" Font-Bold="True" Font-Size="Medium" 
